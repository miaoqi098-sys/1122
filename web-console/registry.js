(() => {
  ...
  const modules = Object.freeze([
    ...
    { id:'amazon-sp-api-console', label:'Amazon SP-API 连接中心', route:'/connectors/amazon-sp-api', kind:'connector', summary:'Amazon SP-API 的只读健康状态与安全接入边界。', connectors:['amazon-sp-api'], legacy_source:'amazon-sp-api.html' }
  ]);
