...
export default {
  async fetch(request, env) {
    ...
    if (url.pathname === "/" || url.pathname === "/health") return json({ ok: true, service: "1122-amazon-ads-bridge", status: "online", version: "1.1.0", checked_at: now(), configured: configured(env) }, 200, origin);
