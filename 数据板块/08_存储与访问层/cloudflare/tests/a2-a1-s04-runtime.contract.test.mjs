...
const ready = await runAgent2ToS04(validInput, {
  ...baseOptions,
...
const missingSourceEvent = await runAgent2ToS04(validInput, {
  ...baseOptions,
...
const stale = await runAgent2ToS04(staleInput, {
  ...baseOptions,
  availableContext: context(sourceEvent),
});
...
const forgedPrivilege = await runAgent2ToS04(
  { ...validInput, dispatchAuthorized: true },
...
console.log('Agent-2 to S04 runtime contract: PASS');
