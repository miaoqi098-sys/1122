...
其中：
- `产品板块/产品推广计划/` 定义单 ASIN / 单站点 / 单经营周期的目标、阶段、约束、策略组合、KPI、里程碑与审批规则；
- `每日工作SOP/` 负责日度数据检查、偏差识别、异常分级、Decision Item 候选、任务草案和执行后验证；
- 每日SOP必须优先读取当前产品推广计划，不把“日报”与“经营目标”割裂。
...
任何日度建议都应能追溯到：事实、数据窗口、当前推广目标和约束条件。
